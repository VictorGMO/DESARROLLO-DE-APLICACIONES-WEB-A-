...
# aca mandamos una variable simple y un diccionario,para cumplir con lo que pide la semana 10
@app.route('/')
def index():
    # variable simple que se muestra con {{ nombre_sistema }} en el html
    nombre_sistema = 'Sistema de Gestión de Inventario'

    # diccionario con informacion general del sistema,no es un registro individual
    # sino datos resumen de todo el proyecto
    estadisticas = {
        'total_productos': 3,
        'total_clientes': 3,
        'total_proveedores': 3
...
# ahora cada producto tiene stock,para poder mostrar disponible o agotado con jinja2
@app.route('/productos')
def productos():
    productos = [
