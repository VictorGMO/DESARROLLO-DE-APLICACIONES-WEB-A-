...
const btnRegistrar = formProducto.querySelector('button[type="submit"]');

// referencias del modal,se usan para mostrar el detalle y eliminar desde ahi
...
// aca se guarda el id del producto que esta abierto en el modal por el momento
...
function renderizarProductos() {
    ...
    productos.forEach(function(producto) {
        ...
        // este boton ya no elimina directo,ahora abre el modal para ver el detalle y confirmar
        const btnVerDetalles = document.createElement('button');
        btnVerDetalles.className = 'btn btn-outline-primary btn-sm w-100 mt-2';
        ...
        cardBody.appendChild(btnVerDetalles);
...
// llena el modal con los datos del producto que se toco y lo muestra
...
// boton eliminar dentro del modal,borra el producto que quedo guardado en idSeleccionado
...
formProducto.addEventListener('submit', function(event) {
    ...
    // se muestra el spinner un rato,como si estuviera guardando en un servidor,y el boton se bloquea mientras tanto
    ...
    setTimeout(function() {
        ...
        // se quita el spinner y se vuelve a habilitar el boton
